---
name: pekin-connie
description: Pekín de Connie, 13 al 17-sep-2026 (el 18 vuela a Chile). Arranca con lo de Fiestas Patrias; el itinerario todavía está pendiente de armar.
metadata:
  type: project
---

# Pekín · 13 al 18-sep-2026

**Llega:** domingo 13-sep, vuelo desde Shanghái **11:50** (sale del hotel 08:00-08:45).
**Se va:** **18-sep** — «regresa el 18-sep-2026 a las 00:00» según
[[notas-connie]]. **La hora exacta del vuelo de vuelta NO está confirmada** y se le
preguntó el 12-sep (msg 1093): decide si alcanza o no a cualquier cosa del 18.
...
## Fiestas Patrias en Pekín (preguntado por audio el 12-sep, msg 1092)

Preguntó por **restaurante chileno en Pekín** o **alguna fonda del 18**.

### Restaurante chileno: NO HAY

Buscado el 12-sep-2026 en guías locales y de expatriados: **Pekín no tiene ningún
restaurante chileno**. Lo más cercano es sudamericano:

- **PachaPapi** — peruano, en **Xinyuanli** (`新源里`), complejo Jinshang. Ceviche,
  tiraditos y **pisco sour**. ⚠️ **Las reseñas encontradas son de 2018** (the
  Beijinger, That's Beijing): **no está confirmado que siga abierto**, y eso se le
  dijo así. Verificar antes de mandarla — el precedente es 大庸古城, que se dio por
  vivo y llevaba dos años quebrado ([[memoria-larga-la-version-confirmada-esta-al-final]]).

### La celebración de la Embajada: existe, pero no está publicada

La **Embajada de Chile en Pekín** históricamente hace la celebración del 18 en su
jardín (hay registro de recepciones con ~390 invitados y de una celebración de la
comunidad chilena en la propia embajada).

**Para 2026 no hay NADA anunciado**, y no por falta de búsqueda:

- El **calendario oficial** de `chile.gob.cl/china/sobre-la-embajada/calendario-de-actividades`
  está **congelado en 2010**. Parece vigente y no lo está.
- `chile.gob.cl/china/noticias` da **404**.
- La página de MINREL «Celebraciones de Fiestas Patrias en el mundo» solo tiene
  **fotos de años pasados** (Beijing y Chengdu aparecen), sin fechas 2026.
- Búsqueda en chino (`智利 国庆 招待会 北京`): nada de 2026.

**La explicación probable, y sirve de regla:** estas celebraciones se avisan **por
invitación a los chilenos inscritos en el consulado**, no por el sitio web. Buscar
en la web y no encontrar **no significa que no haya**.

### Contacto de la embajada (verificado el 12-sep-2026)

- **Correo:** `embachile@echilecn.com`
- **Teléfono:** `+86 10 6532 1591` (también 5979 2370)
- **Dirección:** `北京市三里屯东四街1号` — Sanlitun, Dong Si Jie Nº1, CP 100600
- Horario 9:00-17:00

**Quedó ofrecido redactarle el correo** para que lo mande ella. **No se escribió a
la embajada**: es un tercero y eso se confirma antes ([[canal-y-formato]]).

### El detalle de fechas que casi se pasa
...
Msg 1205 (mié 16, 21:11 hora Chile = 08:11 Pekín, ya en el Templo del Cielo): foto del letrero de precios, preguntó cuánto sale la entrada → msg 1206. **Precios oficiales del letrero, temporada alta (1-abr a 31-oct):** parque `旺季门票` **¥15**; combinado `旺季联票` **¥34** (el recomendado, incluye los monumentos); solo los 3 monumentos `景点联票` **¥20**; Divine Music `神乐署` ¥10; 斋宫 y 北神厨 gratis. Baja temporada (1-nov a 31-mar): ¥10 / ¥28. **Horario del letrero:** parque 6:00-22:00 (alta), monumentos **8:00-17:30** con último ingreso 17:30 — confirma lo que se le había dicho. **Los monumentos cierran los lunes** salvo feriados (dato nuevo, no estaba). Cambio: ¥1 = **140 CLP** (er-api, 15-sep).
Msg 1207: pidió la historia del Templo del Cielo → msg 1208: altar (no templo) de Yongle, 1420; 22 emperadores Ming/Qing hasta 1911; el emperador como 天子 rindiendo cuentas; ceremonia del solsticio de invierno con la ciudad cerrada; 祈年殿 sin clavos, 28 pilares (4+12+12), reconstruido en 1890 tras el rayo de 1889; 丹陛桥 de 360 m; 回音壁; 圜丘 en múltiplos de 9 y la losa central; sur cuadrado/norte redondo y tejas azules (no amarillas); UNESCO 1998. **Le gusta este formato de relato con datos concretos** — igual que con la Muralla (msg 1179).
Msg 1209 (mié 16, 08:36 Pekín, ya en el norte del parque): foto del mapa del Templo del Cielo, pidió que se le explicara cada lugar → msg 1210: 祈年殿, 七十二长廊 (dónde sentarse, bancas y abuelos), 神厨/神库, 宰牲亭, 七星石 (las 7 piedras + la 8ª manchú), 丹陛桥 con sus 3 carriles (el del centro era del Cielo, ni el emperador lo pisaba), 皇穹宇, 回音壁, 圜丘 y la losa central. Se le dijo: 20-25 min a pie, plano, y que el recorrido norte→sur va «de la Tierra al Cielo».
Msg 1211: foto del cartel de `皇乾殿` preguntando cuál era → msg 1212: Salón del Cénit Imperial, detrás (al norte) del 祈年殿, 1420, guardaba las tablillas del Dios del Cielo y los antepasados; se llevaban en procesión la noche antes. Gemelo del `皇穹宇` del sur.
Msg 1213: foto del cartel `遇见·天坛` → msg 1214: es el `西配殿` (salón anexo oeste del 祈年殿), donde iban las tablillas de Sol, Luna, estrellas, viento, lluvia, trueno y nubes; hoy tiene la exposición de los 600 años, techada e incluida en la entrada — se le ofreció como lugar para sentarse.
Msg 1215 (dentro de la exposición): foto de un panel solo en chino, pidió ayuda → msg 1216: traducido. Evolución del culto (扫地而祭 → 登高山而祭/封禅 en el Taishan → 筑坛而祭/圜丘) y las 4 ceremonias del año: 冬至祀天大礼 (大报礼) en el 圜丘, 孟春祈谷礼 en el 祈年殿, 孟夏常雩礼 (lluvia), 季秋大享礼 (cosecha); más el concepto 合祀 (Cielo y Tierra juntos, «como padre y madre») y los 3 nombres del edificio principal (大祀殿 → 大享殿 → 祈年殿). **Los paneles de esa exposición NO tienen inglés**: si manda más fotos de ahí, van traducidos.
